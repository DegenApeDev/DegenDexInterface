...
import { Currency, CurrencyAmount, ETHER, JSBI, Token, TokenAmount, Trade } from '@degendex/sdk'
import { ParsedQs } from 'qs'
import { useCallback, useEffect, useState } from 'react'
import { useDispatch, useSelector } from 'react-redux'
import { DDEX } from '../../constants'
...
export function useDerivedSwapInfo(): {
  ...
  const outputCurrency = useCurrency(outputCurrencyId || DDEX.address)
